 ...
 */
package mg.itu.abrahamram.tpbanqueabraham.jsf.util;
...
public class MessageUtil {
  ...
  public static void addFlashMessage(FacesMessage message, String idClient) {
    FacesContext facesContext = FacesContext.getCurrentInstance();
    Flash flash = facesContext.getExternalContext().getFlash();
    flash.setKeepMessages(true);
  ...
  public static void addFlashErrorMessage(String message, String idClient) {
    FacesMessage msg = 
            new FacesMessage(FacesMessage.SEVERITY_ERROR, message, message);
    addFlashMessage(msg, idClient);
  }

  public static void addFlashInfoMessage(String message, String idClient) {
    FacesMessage msg = 
            new FacesMessage(FacesMessage.SEVERITY_INFO, message, message);
    addFlashMessage(msg, idClient);
  }
